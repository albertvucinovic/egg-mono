...
- 2026-07-24: Removed Runtime's invalid single-root inference. The cached `eggopt.runtime.create-study.v1` Eggflow Task is now the sole study-root authority: it creates and returns the thread ID once, and resumed runs reuse that stored value regardless of unrelated Eggthreads roots.
