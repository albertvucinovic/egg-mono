...
- [x] Run focused eggllm tests.
- [x] Run focused eggthreads token/cost/runner tests.
- [x] Run any nearby Egg UI/command tests affected by `/cost` display.
- [x] Update this TODO with final status, commands, results, commits, and caveats.
...
- 2026-06-11: Phase 5 final verification completed. Commands/results: `python -m pytest eggllm/tests/test_openai_responses.py eggllm/tests/test_client_sanitize.py eggllm/tests/test_registry.py eggllm/tests/test_provider_http.py -q` (55 passed); `python -m pytest eggthreads/tests/test_token_count_public.py eggthreads/tests/test_usage_metadata_sanitization.py eggthreads/tests/test_command_registry.py eggthreads/tests/test_runner_auto_continue.py eggthreads/tests/test_reasoning_summary_display_only.py eggthreads/tests/test_tool_message_format.py eggthreads/tests/test_tool_call_id_normalization.py eggthreads/tests/test_toolcall_protocol_enforcement.py -q` (88 passed); `python -m pytest egg/tests/test_formatting.py egg/tests/test_commands_utility.py egg/tests/test_commands_display.py -q` (83 passed). Implementation commits: `d450a05` Phase 1 provider usage capture, `022b72f` Phase 2 persistence/sanitization, `c8cc5de` Phase 3 precise token/cost aggregation, `18adf87` Phase 4 config/visibility. Caveats: no browser/eggw `/cost` parity change was included; `count-lines.sh` remained untouched/untracked. Precise-cost implementation plan is complete through Phase 5.
