...
- 2026-05-09: Added system-prompt guidance for hydrated REPL thread context and fixed generic command dispatch to log non-empty `CommandResult.message`, while keeping `/compact` from double-logging through both its handler and generic dispatch. Focused tests pending in this uncommitted slice.
