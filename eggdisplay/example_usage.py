#!/usr/bin/env python3
"""
Example usage of the Rich Text Editor.

This script demonstrates how to use the text editor with event listeners
...
def main():
    ...
    def on_text_change(change_type: str, row: int, col: int, data: str):
        print(f"[Text Change] {change_type} at line {row}, column {col}")
    ...
    def on_key_press(key: str, row: int, col: int):
        print(f"[Key] '{key}' pressed at ({row}, {col})")
